    ...
    >
      <svg className={classNames(styles.PromptEffectContainer)}>
        <defs>
          ...
          >
            <stop offset="0%" stopColor="#FFAA56" stopOpacity="0%"></stop>
            <stop offset="30%" stopColor="#13C9C2" stopOpacity="80%"></stop>
            <stop offset="60%" stopColor="#4672F4" stopOpacity="80%"></stop>
            <stop offset="100%" stopColor="#FFAA56" stopOpacity="0%"></stop>
          </linearGradient>
      ...
      >
        ...
        <div className="flex justify-between items-center text-sm p-4 pt-2">
          <div className="flex gap-1 items-center">
              ...
              {importMenuOpen && (
                <>
                  ...
                  <div className="absolute bottom-9 left-0 bg-bolt-elements-bg-depth-2 border border-bolt-elements-borderColor rounded-xl shadow-lg overflow-hidden z-50 min-w-[170px]">
                    ...
                    <ImportFolderButton importChat={props.importChat} className="" />
            ...
            <IconButton
              title={props.isModelSettingsCollapsed ? 'Show model settings' : 'Hide model settings'}
              className={classNames('transition-all flex items-center', {
                'text-bolt-elements-item-contentAccent': !props.isModelSettingsCollapsed,
                'text-bolt-elements-item-contentDefault opacity-50 hover:opacity-100': props.isModelSettingsCollapsed,
              })}
              onClick={() => props.setIsModelSettingsCollapsed(!props.isModelSettingsCollapsed)}
              disabled={!props.providerList || props.providerList.length === 0}
            >
              <div className="i-ph:sliders-horizontal text-lg" />
            </IconButton>
          </div>
