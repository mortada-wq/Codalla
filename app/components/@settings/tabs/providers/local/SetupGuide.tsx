      ...
      <Card className="bg-bolt-elements-background-depth-2 shadow-sm">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-lg bg-blue-500/15 border border-green-500/20">
              <div className="flex items-center gap-2 mb-3">
                <Monitor className="w-5 h-5 text-blue-400" />
                <h5 className="font-medium text-blue-400">🆕 Desktop App (Recommended)</h5>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-lg bg-blue-500/15 border border-green-500/20">
                <h5 className="font-medium text-blue-400 mb-2">Useful Commands</h5>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="p-4 rounded-lg bg-blue-500/15 border border-green-500/20">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="font-medium text-blue-400">LocalAI Advantages</span>
            </div>
            <ul className="text-xs text-bolt-elements-textSecondary space-y-1 list-disc list-inside">
