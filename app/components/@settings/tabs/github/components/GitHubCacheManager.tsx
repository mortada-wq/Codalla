...
export function GitHubCacheManager({ className = '', showStats = true }: GitHubCacheManagerProps) {
  ...
  return (
    ...
    >
      ...
      {lastClearTime && (
        <div className="flex items-center gap-2 p-2 bg-blue-500 dark:bg-blue-500/15 border border-green-200 dark:border-green-700 rounded text-xs text-blue-400 dark:text-blue-400">
