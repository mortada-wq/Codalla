                          ...
                          <span
                            className={classNames(
                              ...
                              project.status === 'ACTIVE_HEALTHY'
                                ? 'bg-blue-500 text-blue-400 dark:bg-blue-500/15 dark:text-blue-400'
      ...
      {connectionTest && (
        <motion.div
          className={classNames('p-4 rounded-lg border', {
            'bg-blue-500 border-green-200 dark:bg-blue-500/15 dark:border-green-700':
        ...
        >
          <div className="flex items-center gap-2">
            {connectionTest.status === 'success' && (
              <div className="i-ph:check-circle w-5 h-5 text-blue-400 dark:text-blue-400" />
            )}
            ...
            <span
              className={classNames('text-sm font-medium', {
                'text-blue-400 dark:text-blue-400': connectionTest.status === 'success',
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-bolt-elements-textSecondary flex items-center gap-1">
                    <div className="i-ph:check-circle w-4 h-4 text-blue-400" />
                      ...
                      {(() => {
                        ...
                        return [
                          ...
                          },
                          {
                            ...
                            icon: 'i-ph:folder',
                            color: 'text-blue-400',
                            bgColor: 'bg-blue-500 dark:bg-blue-500/15',
