  ...
  return (
    <motion.div
      className={classNames(
        ...
        {
          'bg-blue-500 border-green-200 dark:bg-blue-500/15 dark:border-green-700': testResult.status === 'success',
      ...
      <div className="flex items-center gap-2">
        ...
        <span
          className={classNames('text-sm font-medium', {
            'text-blue-400 dark:text-blue-400': testResult.status === 'success',
